package com.sharebedapp.jijl.config;

import com.sharebedapp.jijl.handler.BackLoginInterceptor;
import com.sharebedapp.jijl.handler.BackRoleInterceptor;
import com.sharebedapp.jijl.handler.FrontLoginInterceptor;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
       registry.addInterceptor(jwtLoginInterceptor()).addPathPatterns("/front/**");
        ...
        registry.addInterceptor(authorityInterceptor()).addPathPatterns("/back/**");
    ...
    @Bean
    BackRoleInterceptor authorityInterceptor() {
        return new BackRoleInterceptor();
    }
}

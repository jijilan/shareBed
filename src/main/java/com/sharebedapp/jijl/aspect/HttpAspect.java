package com.sharebedapp.jijl.aspect;


import com.sharebedapp.jijl.handler.GlobalExceptionHandler;
...
public class HttpAspect {
    ...
    @Pointcut("execution(public * com.sharebedapp.jijl.controller..*.*(..))")
    public void log(){
